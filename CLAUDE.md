# CLAUDE.md — Atlas (COO & Quality Manager) · CLI Fallback Bootstrap
...
Then follow the **Every Session** startup checklist in `AGENTS.md` (includes reading
`../../design/virtual-company-design.md`, `../../CONTEXT.md`, `../../BACKLOG.md`, and `memory/`).
